    ...
    <div className="max-w-3xl">
      ...
      <form onSubmit={save} className="mt-6 space-y-6">
        ...
        <section className="card p-5">
          ...
          <p className="text-xs text-ink-700 mb-4 bg-amber-50 border border-amber-200 rounded px-3 py-2">
            <strong>Tip:</strong> use <code className="bg-white px-1 rounded">{'{free_above}'}</code> or <code className="bg-white px-1 rounded">{'{flat_fee}'}</code> as placeholders for the live delivery values you set below. Example: <em>Free delivery in UAE on orders over AED {'{free_above}'}</em> — when you change the threshold, every announcement updates with it automatically.
          </p>
